...
from DEVIL import app as Hiroko
...
bg_path = "DEVIL/assets/userinfo.png"
font_path = "DEVIL/assets/hiroko.ttf"
...
@Hiroko.on_message(filters.command(["info", "biodata"], prefixes=["/", "!", "? ", "."]))
