...
from DEVIL.utils import get_readable_time
...
from DEVIL.utils.extraction import extract_user
from config import BANNED_USERS


@app.on_message(filters.command(["gban", "chutiya", "bsdk", "gaand faad ban"]) & SUDOERS)
@language
